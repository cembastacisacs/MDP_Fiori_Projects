sap.ui.define([
	"sap/ui/test/Opa5",
	"MDPCustomerAddress2/MDPCustomerAddress2/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function (Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("MDPCustomerAddress2.MDPCustomerAddress2.test.integration.arrangements.Startup", {
		...
		iStartMyApp: function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "MDPCustomerAddress2.MDPCustomerAddress2",
					async: true
				},
				hash: oOptions.hash,
