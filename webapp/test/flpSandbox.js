		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "MDPCustomerAddress2",
									"targetURL": "#MDPCustomerAddress2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"MDPCustomerAddress2-display": {
								"semanticObject": "MDPCustomerAddress2",
								"action": "display",
								"description": "MDPCustomerAddress2",
								"title": "MDPCustomerAddress2",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=MDPCustomerAddress2.MDPCustomerAddress2",
									"url": sap.ui.require.toUrl("MDPCustomerAddress2/MDPCustomerAddress2")
								}
							}
						}
					}
